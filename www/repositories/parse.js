/**
* Repositorio de objetos do Parse.org. Baseado no design partner Repository.
...
var ParseRepository = PrototypeClass.extend({
   ...
   prototype: {
       ...
       **/
       ...
       /**
       * Parse query object for the parse class
       **/
       _query: function(){
   ...
   /**
   * Class "static" method for Callback and error callback handler
   **/
